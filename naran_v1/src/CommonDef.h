...
#define BITS_FIRST_BIT2(VAL, N)			(BITS_CHECK_ZEROS(VAL, (N)+1, 1) ? BITS_FIRST_BIT1(VAL, N) : (N)+1)
#define BITS_FIRST_BIT4(VAL, N)			(BITS_CHECK_ZEROS(VAL, (N)+2, 2) ? BITS_FIRST_BIT2(VAL, N) : BITS_FIRST_BIT2(VAL, (N)+2))
#define BITS_FIRST_BIT8(VAL, N)			(BITS_CHECK_ZEROS(VAL, (N)+4, 4) ? BITS_FIRST_BIT4(VAL, N) : BITS_FIRST_BIT4(VAL, (N)+4))
#define BITS_FIRST_BIT16(VAL, N)		(BITS_CHECK_ZEROS(VAL, (N)+8, 8) ? BITS_FIRST_BIT8(VAL, N) : BITS_FIRST_BIT8(VAL, (N)+8))
#define BITS_FIRST_BIT32(VAL, N)		(BITS_CHECK_ZEROS(VAL, (N)+16, 16) ? BITS_FIRST_BIT16(VAL, N) : BITS_FIRST_BIT16(VAL, (N)+16))
